...
constexpr auto GetSlavicMinutes = SlavicGenerate({
    "минут", "минута", "минуты",
    "минут", "минуты", "минут", 
    "минут", "минуте", "минутам",
    "минут", "минуту", "минуты",
    "минут", "минутой", "минутами",
    "минут", "минуте", "минутах"
});

constexpr auto GetSlavicSeconds = SlavicGenerate({
    "секунд", "секунда", "секунды",
    "секунд", "секунды", "секунд", 
    "секунд", "секунде", "секундам",
    "секунд", "секунду", "секунды",
    "секунд", "секундой", "секундами",
    "секунд", "секунде", "секундах"
});
